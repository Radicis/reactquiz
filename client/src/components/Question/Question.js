...
function Question({
  ...
  return (
    <div className="flex flex-col flex-grow">{renderSwitch(questionType)}</div>
  );
  ...
  function renderSwitch(param) {
    switch (param) {
      ...
      default:
        return (
          <div className="flex justify-center items-center text-center p-4 flex-grow text-question">
            {questionContent}
          </div>
        );
    }
